...
Bayesian inference for a mixed-effects model follows from standard inference (i.e., it is simply an application of Bayes Theorem for probability densities), but two implementation assumptions are made:
