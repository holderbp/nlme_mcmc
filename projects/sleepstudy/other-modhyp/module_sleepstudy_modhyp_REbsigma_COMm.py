...
#
model_hyp = 'RE-single-group-b-sigma-common-m'
#
...
#
widthfac = 5.0
mm.list_indiv_pop_pars = ['b', 'sigma']
mm.descrip_name['b'] = 'intercept'
mm.descrip_name['sigma'] = 'data error variance'
init_vecs = [
...
# two population parameters to be followed by MCMC
mm.pop['sigma_mean'], mm.pop['sigma_stdev'] = 20.0, 1.5
# prior and transformation for the mean    
mm.prior_dist['sigma_mean'] = 'lognormal'
mm.prior_mean['sigma_mean'], mm.prior_stdev['sigma_mean'] = 20.0, widthfac
mm.prior_min['sigma_mean'], mm.prior_max['sigma_mean'] = 0.0, 5.0
...
mm.prior_mean['sigma_stdev'], mm.prior_stdev['sigma_stdev'] = widthfac, widthfac
mm.prior_min['sigma_stdev'], mm.prior_max['sigma_stdev'] = 0.0, 5.0
...
#             [<pop pars>, sigma]
#
important_pars = ['b_mean', 'b_stdev', 'sigma_mean', 'sigma_stdev', 'm']
...
def get_log_likelihood():
    ...
    for i in mm.indiv_names:
        # sigma is a random effect
        sigma_sqrd = mm.indiv_pop.at[i, 'sigma']**2
