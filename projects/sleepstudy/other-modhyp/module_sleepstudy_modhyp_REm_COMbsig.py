...
#
model_hyp = 'RE-single-group-m-common-b-sigma'
#
...
#
mm.list_other_pars = ['b', 'sigma']
# prior and transformation for slope
mm.descrip_name['b'] = 'common intercept'
mm.other['b'] = 300.0
...
#             [<pop pars>, sigma]
#
important_pars = ['m_mean', 'm_stdev', 'b', 'sigma']
