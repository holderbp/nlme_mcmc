...
#                        <none>
#
mm.list_indiv_nopop_pars = ['m', 'b', 'sigma']
init_vecs = [
    [25, 0.0, 10, 15, 2, 0,
     15, 25, -10, 15, 5, 10,
     0, 5, 10, 10, 5, 5],
...
# prior and transformation for slope
mm.descrip_name['b'] = 'intercept'
mm.prior_dist['b'] = 'normal'
mm.prior_mean['b'], mm.prior_stdev['b'] = 300.0, 100.0
mm.prior_min['b'], mm.prior_max['b'] = 200.0, 400.0
mm.transf_mcmc['b'] = 'none'
mm.transf_plot['b'] = 'none'
...
mm.prior_mean['sigma'], mm.prior_stdev['sigma'] = 20.0, widthfac
...
#             [<pop pars>, sigma]
#
important_pars = ['m[308]', 'b[308]', 'sigma[308]']
...
def get_log_likelihood():
    ...
    for i in mm.indiv_names:
        # individual sigmas
        sigma_sqrd = mm.indiv_nopop.at[i, 'sigma']**2
