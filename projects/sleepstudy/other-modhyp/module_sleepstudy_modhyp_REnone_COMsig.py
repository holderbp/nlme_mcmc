...
#        generated by each evolve-model (mm.datasets_for_indiv), which
...
def get_log_likelihood():
    ...
    # (set within the mm.datasets_for_indiv[i][em] loop below):
    #
    #      if (d == 'virus-decay'):
