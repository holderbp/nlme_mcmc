...
#
model_hyp = 'IPOP-none_INOPOP-N-tauT-tD_COM-none_CONST-nT-s'
#
...
#
mm.list_indiv_nopop_pars = ['N', 'tauT', 'dD']
#
...
#=== DISCRETE PARAMETERS 
#
discrete_pars = []    # will seek out <parname>+'[' and <parname>+'_mean' as well
